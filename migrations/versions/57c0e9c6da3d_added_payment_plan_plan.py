"""added payment plan & plan

Revision ID: 57c0e9c6da3d
Revises: 
Create Date: 2019-04-10 10:19:50.130647
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['payment_plan_id'], ['payment_plan.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
