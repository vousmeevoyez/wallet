...
def test_transfer_invalid_destination(client, setup_user_wallet_va,
                                      setup_user_wallet_va_without_balance):
...
def test_transfer_locked_source(client, setup_user_wallet_va,
                                setup_user_wallet_va_without_balance):
...
def test_transfer_incorrect_pin(client, setup_user_wallet_va,
                                setup_user_wallet_va_without_balance):
...
def test_bank_transfer_bank_account_not_found(client, setup_user_wallet_va_bank_acc):
    ...
    params = {"amount": "15", "notes": "some notes", "pin": "123456"}
    result = bank_transfer(
        client, wallet_id, str(uuid.uuid4()), params, access_token
    )
