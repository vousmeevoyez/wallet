...
_DEPOSITCALLBACKREQUEST_BODY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="DepositCallbackRequest.Body.virtual_account",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="payment_amount",
            full_name="DepositCallbackRequest.Body.payment_amount",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_DEPOSITCALLBACKRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="status",
            full_name="DepositCallbackResponse.status",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_DEPOSITCALLBACKREQUEST.fields_by_name[
    "body"
].message_type = _DEPOSITCALLBACKREQUEST_BODY
...
DepositCallbackRequest = _reflection.GeneratedProtocolMessageType(
...
DepositCallbackResponse = _reflection.GeneratedProtocolMessageType(
    "DepositCallbackResponse",
    (_message.Message,),
    dict(
